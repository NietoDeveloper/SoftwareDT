  ...
  return (
    <div id="home-wrapper" className="bg-main antialiased min-h-screen selection:bg-gold/30">
      ...
      <main className="max-w-[1900px] mx-auto overflow-hidden space-y-12 sm:space-y-20 px-4 sm:px-8 mt-12 sm:mt-20">
        ...
        <section className="border-[1px] border-black/10 transition-all duration-500 rounded-[2.5rem] overflow-hidden bg-white hover:border-[#FEB60D]/30 hover:shadow-[0_20px_60px_rgba(254,182,13,0.15)]">
          <About />
        </section>
        ...
        <section className="border-[1px] border-black/10 transition-all duration-500 rounded-[2.5rem] overflow-hidden bg-white mb-20 hover:border-[#FEB60D]/30 hover:shadow-[0_20px_60px_rgba(254,182,13,0.15)]">
          <Questions />
        </section>
      </main>
