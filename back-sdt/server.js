...
// --- CORRECCIÓN AQUÍ: Importaciones sin llaves para exports directos ---
...
// 🚀 Citas: Middleware opcional (Ahora cargará correctamente)
app.use('/api/appointments', optionalAccess, require('./routes/appointmentRoute'));

// --- PROTECCIÓN GLOBAL (Middlewares de seguridad) ---
