...
// CORRECCIÓN CLAVE: Se usa '../' para subir un nivel (de 'pages' a 'src') y luego entrar a 'context'.
...
            // En un entorno real, aquí harías una llamada 'fetch' o 'axios' a tu backend.
