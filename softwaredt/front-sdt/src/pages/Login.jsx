...
// Importación ajustada para resolver el error de resolución del módulo, omitiendo la extensión
...
const Login = () => {
    ...
    // Desestructuración mejorada: asegúrate de que UserContext proporciona estos métodos
        ...
        try {
            ...
            const mockResponse = {
                data: {
                    ...
                    userData: { name: 'Usuario Ejemplo', email: data.email, userId: 'patient-789' } // Agregamos un ID de usuario para consistencia
                }
            };
