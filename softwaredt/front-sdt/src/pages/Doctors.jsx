...
  // MODIFICADO: Ahora recibe el objeto doctor completo
  const handleDoctorClick = (doctor) => {
    // Navega y pasa el objeto 'doctor' dentro del objeto 'state'
    navigate(`/book-appointment/${doctor._id}`, { state: { doctorData: doctor } });
  };

  // MODIFICADO: Ahora recibe el objeto doctor completo
  const handleBookAppointmentClick = (e, doctor) => {
    e.stopPropagation();
    // Navega y pasa el objeto 'doctor' dentro del objeto 'state'
    navigate(`/book-appointment/${doctor._id}`, { state: { doctorData: doctor } });
  };
...
              onClick={(e) => handleBookAppointmentClick(e, doctor)}
            >
