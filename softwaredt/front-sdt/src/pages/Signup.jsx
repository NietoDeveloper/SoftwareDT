...
// 1. Retrieve the Firebase configuration provided by the environment
const firebaseConfig = typeof __firebase_config !== 'undefined' ? JSON.parse(__firebase_config) : {};

// 2. FIX: Safely ensure the storageBucket property exists for Firebase Storage
if (firebaseConfig.projectId && !firebaseConfig.storageBucket) {
    // Firebase Storage bucket is typically derived from the projectId
    firebaseConfig.storageBucket = `${firebaseConfig.projectId}.appspot.com`;
    console.log("Firebase Storage Bucket set to:", firebaseConfig.storageBucket);
}

// 3. Initialize Firebase and Storage
...
const Signup = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            // Create a unique reference path for the image
            ...
            // Data to send to your external backend server
            const formData = {
                name: data.name,
                email: data.email,
            ...
            // NOTE: External requests to 'http://localhost' will fail in this environment. 
            // Replace 'http://localhost:8080' with your actual public server endpoint.
