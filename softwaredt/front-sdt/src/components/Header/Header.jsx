...
const Header = () => {
    ...
    return (
        <header className="bg-white shadow-md sticky top-0 z-50">
            ...
            {isMenuOpen && (
                <div className={`md:hidden bg-white border-t border-gray-100 h-[50vh] overflow-auto transition-all duration-300 ease-in-out ${isMenuOpen ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4'}`}>
