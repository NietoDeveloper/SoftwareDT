...
const Header = () => {
    ...
    return (
        <header className="bg-transparent backdrop-blur-xl shadow-md sticky top-0 z-50">
            ...
            {isMenuOpen && (
                <div className={`md:hidden bg-transparent backdrop-blur-xl border-t border-gray-100 max-h-[50vh] overflow-auto transition-all duration-300 ease-in-out ${isMenuOpen ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4'}`}>
