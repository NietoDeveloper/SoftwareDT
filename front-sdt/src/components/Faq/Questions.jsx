  ...
  return (
    <section className="relative min-h-screen w-full bg-black flex items-center justify-center overflow-hidden questions-section">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        /* Mantenemos el Gold oficial de Software DT */
        .questions-section .text-gold, 
        .questions-section .text-gold span {
          color: #FEB60D !important; /* Usando tu yellowColor/gold oficial */
        }

        /* Ajuste para que el texto dentro del FAQ sea blanco también */
        .questions-section .faq-item button,
        .questions-section .faq-item div {
          color: #ffffff !important;
        }
      `}} />

      {/* VIDEO: Intensidad bajada (opacity-20) para que las letras blancas resalten más */}
      <video
        autoPlay
        loop
        muted
      ...
      <div className="relative z-10 container mx-auto px-6 py-20 flex flex-col items-center">
        ...
        <h2 className="text-4xl lg:text-6xl font-black tracking-[0.2em] text-center mb-16 uppercase text-white">
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center gap-12 lg:gap-20 w-full max-w-7xl">
          ...
          {/* Imagen con borde blanco sutil */}
          <div className="w-full lg:w-1/2 relative group">
            <div className="absolute -inset-2 bg-white/5 rounded-[2.5rem] blur-2xl group-hover:bg-gold/20 transition duration-500"></div>
            <img 
              src={equipo2} 
              alt="faq" 
