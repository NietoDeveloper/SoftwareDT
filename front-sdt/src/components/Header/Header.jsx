...
const Header = () => {
    ...
    return (
        <header className="bg-transparent backdrop-blur-3xl shadow-lg sticky top-0 z-50">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <nav className="hidden md:flex space-x-4 items-center text-sm">
                        ...
                        <Link to="/Services" className="text-black hover:text-yellow-500 font-medium transition-colors">Informacion Servicios</Link>
            ...
            {isMenuOpen && (
                <div className={`md:hidden bg-transparent backdrop-blur-3xl border-t border-gray-100 max-h-[70vh] overflow-auto transition-all duration-300 ease-in-out`}>
