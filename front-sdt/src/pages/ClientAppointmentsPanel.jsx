        ...
        <div className="max-w-[1800px] mx-auto flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
          <div className="space-y-2">
            ...
            <h1 className="text-5xl sm:text-7xl font-black text-black uppercase tracking-tighter leading-[0.8]">
              Panel <span className="text-[#FFD700] drop-shadow-[0_0_10px_rgba(255,215,0,0.3)]">Cliente</span>
            </h1>
          </div>
                  ...
                  <div key={appt._id} className="bg-white border-2 border-black/5 rounded-[2rem] p-6 hover:shadow-[0_10px_30px_rgba(255,215,0,0.15)] transition-all group">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                      <div className="flex items-center gap-6">
                        ...
                        <div>
                          <h3 className="text-lg font-black uppercase tracking-tight">{appt.serviceName || "Soporte Técnico"}</h3>
