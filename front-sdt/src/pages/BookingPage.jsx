...
const BookingPage = () => {
  ...
  const availableTimes = useMemo(() => {
    ...
    for (let hour = 9; hour <= 18; hour++) {
      for (let min of ["00", "30"]) {
        ...
        // Solo agregar si es después de 6 horas desde "ahora"
  ...
  const handleInputChange = (e) => {
    ...
    // Si cambia la fecha, resetear la hora para validar de nuevo
      ...
      <main className="flex-grow">
        <div className="mx-auto px-4 py-12 max-w-screen-xl">
          ...
          <div className="flex flex-col lg:flex-row justify-center items-stretch gap-10">
            {/* Tarjeta de Información (No tocada) */}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    >
                      <option value="">{formData.appointmentDate ? "Selecciona hora" : "Primero elige fecha"}</option>
                ...
                {formData.appointmentDate && availableTimes.length === 0 && (
                  <p className="text-xs font-bold text-amber-700 uppercase">No hay horarios disponibles para esta fecha (Min. 6h de antelación).</p>
                )}
